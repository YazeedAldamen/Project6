    ...
    public partial class WebForm4 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                SqlCommand comman = new SqlCommand($"select UserName,Email,PhoneNumber from AspNetUsers where Id='{userid}'", connection);
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand command = new SqlCommand($"update AspNetUsers set UserName='{txtName.Text}',Email='{txtEmail.Text}',PhoneNumber='{txtPhone.Text}' where Id={userid}", connection);
